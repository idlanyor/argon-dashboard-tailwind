...
module.exports = {
  ...
  plugins: [
    ...
    // Recreate the custom utilities and components
    {
      postcssPlugin: 'custom-utilities', // Replace with your plugin name
      Once: ({ addUtilities, addComponents }) => {
    ...
    // Recreate the matchUtilities plugin
    {
      postcssPlugin: 'custom-match-utilities', // Replace with your plugin name
      Once: ({ matchUtilities }) => {
        matchUtilities({
          "bg-gradient": (angle) => ({
